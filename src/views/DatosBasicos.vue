              ...
              <div class="col-md-6 col-lg-5 offset-lg-2">
                ...
                <form action="#" id="step02">
                  <div class="input">
                    ...
                    <input type="text" name="rutst02">
                    <div class="small-text">Sin puntos y con guión (11111111-1)</div>
                  </div>
                  <div class="input">
                    <label>Correo electrónico</label>
                    <input type="text" name="emailst02">
                  </div>
                  <div class="input">
                    <label>Confirme su correo electrónico</label>
                    <input type="text" name="email2st02">
                  </div>
                  <div class="input">
                    <label>Teléfono</label>
                    <input type="text" name="phonest02">
                  </div>
                  <div class="input">
                    <div class="input-select">
                      <select name="camararegional01_st02">
                        <option value="#">Cámara Regional a la que postula</option>
                      </select>
                    </div><span aria-label="Tenemos presencia en todo Chile a través de 18 cámaras regionales" data-microtip-position="right" role="tooltip">?   </span>
                  </div>
                  <h2 class="u-mt90">TIPO DE POSTULACIÓN</h2>
                  <P class="u-mb40">Indique la naturaleza de la institución o persona que postula para ser socio de la Cámara Chilena de la Construcción</P>
                  <div class="input">
                    <div class="input-select">
                      <select name="camararegional_st02">
                  ...
                  <button class="btn-red small u-mt60" id="submitStep02" type="button" @click="campos()">ENVIAR<i class="fa fa-angle-right"></i></button>
                </form>
              </div>
